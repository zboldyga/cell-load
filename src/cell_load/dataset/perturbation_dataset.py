...
from ..utils.data_utils import GlobalH5MetadataCache, suspected_discrete_torch, suspected_log_torch
...
class PerturbationDataset(Dataset):
    ...
    def get_gene_names(self, output_space="all") -> List[str]:
        ...
        try:
            ...
            if output_space == "gene" and "highly_variable" in self.h5_file["/var"].keys():
